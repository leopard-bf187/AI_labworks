...
[Лабораторная работа №1](https://github.com/leopard-bf187/AI_labworks/tree/Lab1)
```bash
git clone --single-branch -b Lab1 https://github.com/leopard-bf187/AI_labworks.git
```
__Дата завершения:__ 10.09.2026

---

[Лабораторная работа №2](https://github.com/leopard-bf187/AI_labworks/tree/Lab2)
```bash
